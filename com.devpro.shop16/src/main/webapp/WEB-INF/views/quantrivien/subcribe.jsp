		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0">Đăng ký khuyến mãi</h1>
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="${base}/admin">Trang
										chủ</a></li>
								<li class="breadcrumb-item active">Đăng ký khuyến mãi</li>
			...
			<!-- Main content -->
			<!-- /.row -->
			<form class="form-inline" action="${base }/admin/subcribe"
				method="get">
				<div class="row" style="width:100%">
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Đăng ký khuyến mãi</h3>
							...
							<div class="card-body table-responsive p-0">
								<table class="table table-hover text-nowrap">
									...
									<tbody>
										<c:forEach items="${subcribeWithPaging.data}" var="p"
											varStatus="loop">
											<tr>
												<th>${loop.index + 1}</th>
												<td>${p.email}</td>
